...
const createSocketEventsChannel = () =>
  eventChannel((emit) => {
    ...
    const handleProjectManagerCreate = api.makeHandleProjectManagerCreate(
      ({ item }) => {
        emit(entryActions.handleProjectManagerCreate(item));
      },
    );

    const handleProjectManagerDelete = api.makeHandleProjectManagerDelete(
      ({ item }) => {
    ...
    const handleBoardMembershipCreate = api.makeHandleBoardMembershipCreate(
      ({ item }) => {
        emit(entryActions.handleBoardMembershipCreate(item));
      },
    );

    const handleBoardMembershipUpdate = api.makeHandleBoardMembershipUpdate(
      ({ item }) => {
        emit(entryActions.handleBoardMembershipUpdate(item));
      },
    );

    const handleBoardMembershipDelete = api.makeHandleBoardMembershipDelete(
      ({ item }) => {
    ...
    const handleListSort = api.makeHandleListSort(
      ({ item, included: { cards } }) => {
